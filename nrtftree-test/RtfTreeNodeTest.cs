...
namespace Net.Sgoliver.NRtfTree.Test
{
    ...
    public class RtfTreeNodeTest
    {
        ...
        public void TextExtraction()
        {
            ...
            int res = tree.LoadRtfFile(FilePathHelper.GetFilePath("testdocs\\testdoc4.rtf"));
        ...
        public void TextExtractionSpecial()
        {
            ...
            int res = tree.LoadRtfFile(FilePathHelper.GetFilePath("testdocs\\testdoc5.rtf"));
        ...
        public void TextExtractionUnicode()
        {
            ...
            int res = tree.LoadRtfFile(FilePathHelper.GetFilePath("testdocs\\unicodedoc.rtf"));
