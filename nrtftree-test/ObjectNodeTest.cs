...
namespace Net.Sgoliver.NRtfTree.Test
{
    ...
    public class ObjectNodeTest
    {
        ...
        public void LoadObjectNode()
        {
            ...
            tree.LoadRtfFile(FilePathHelper.GetFilePath("testdocs\\testdoc3.rtf"));
        ...
        public void ObjectHexData()
        {
            ...
            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\objhexdata.txt"));
        ...
        public void ObjectBinData()
        {
            ...
            BinaryWriter bw = new BinaryWriter(new FileStream(FilePathHelper.GetFilePath("testdocs\\objbindata-result.dat"), FileMode.Create));
            foreach (byte b in objNode.GetByteData())
                bw.Write(b);
            bw.Close();

            FileStream fs1 = new FileStream(FilePathHelper.GetFilePath("testdocs\\objbindata-result.dat"), FileMode.Open);
            FileStream fs2 = new FileStream(FilePathHelper.GetFilePath("testdocs\\objbindata.dat"), FileMode.Open);
