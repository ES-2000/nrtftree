...
namespace Net.Sgoliver.NRtfTree.Test
{
    ...
    public class LoadRtfTest
    {
        ...
        public void LoadSimpleDocFromFile()
        {
            ...
            int res = tree.LoadRtfFile(FilePathHelper.GetFilePath("testdocs\\testdoc1.rtf"));
            ...
            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\result1-1.txt"));
            string strTree1 = sr.ReadToEnd();
            sr.Close();

            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\result1-2.txt"));
            string strTree2 = sr.ReadToEnd();
            sr.Close();

            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\rtf1.txt"));
            string rtf1 = sr.ReadToEnd();
            sr.Close();

            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\text1.txt"));
        ...
        public void LoadImageDocFromFile()
        {
            ...
            int res = tree.LoadRtfFile(FilePathHelper.GetFilePath("testdocs\\testdoc3.rtf"));
            ...
            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\rtf5.txt"));
            string rtf5 = sr.ReadToEnd();
            sr.Close();

            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\text2.txt"));
        ...
        public void LoadSimpleDocMergeSpecialFromFile()
        {
            ...
            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\result1-3.txt"));
            string strTree1 = sr.ReadToEnd();
            sr.Close();

            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\result1-4.txt"));
            string strTree2 = sr.ReadToEnd();
            sr.Close();
        ...
        public void LoadSimpleDocFromString()
        {
            ...
            StreamReader sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\testdoc1.rtf"));
