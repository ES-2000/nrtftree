...
namespace Net.Sgoliver.NRtfTree.Test
{
    ...
    public class RtfDocumentTest
    {
        ...
        public void CreateSimpleDocument()
        {
            ...
            doc.Save(FilePathHelper.GetFilePath("testdocs\\rtfdocument1.rtf"));
            ...
            doc.Save(FilePathHelper.GetFilePath("testdocs\\rtfdocument2.rtf"));

            StreamReader sr = null;
            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\rtfdocument1.rtf"));
            string rtf1 = sr.ReadToEnd();
            sr.Close();

            sr = null;
            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\rtfdocument2.rtf"));
            string rtf2 = sr.ReadToEnd();
            sr.Close();

            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\rtf4.txt"));
            string rtf4 = sr.ReadToEnd();
            sr.Close();

            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\rtf6.txt"));
            string rtf6 = sr.ReadToEnd();
            sr.Close();

            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\doctext1.txt"));
            string doctext1 = sr.ReadToEnd();
            sr.Close();

            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\doctext2.txt"));
