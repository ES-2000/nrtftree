...
namespace Net.Sgoliver.NRtfTree.Test
{
    ...
    public class ImageNodeTest
    {
        ...
        public void ImageHexData()
        {
            ...
            sr = new StreamReader(FilePathHelper.GetFilePath("testdocs\\imghexdata.txt"));
        ...
        public void ImageBinData()
        {
            ...
            imgNode.SaveImage(FilePathHelper.GetFilePath("testdocs\\img-result.png"), ImageFormat.Jpeg);

            Stream fs1 = new FileStream(FilePathHelper.GetFilePath("testdocs\\img-result.jpg"), FileMode.Open);
            Stream fs2 = new FileStream(FilePathHelper.GetFilePath("testdocs\\image1.jpg"), FileMode.Open);
